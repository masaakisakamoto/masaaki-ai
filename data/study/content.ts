...
export const sportsCityApplications = [
  {
    title: "市民向けの運動の入口づくり",
    description:
      "難しい運動ではなく、誰でも始められる小さな動きを入口にして、地域全体に運動のきっかけを広げる。",
  },
  {
    title: "小中学校との連携",
    description:
...
export const sportsProgramGroups = [
  {
    ...
    title: "親子・家庭",
    description:
      "家庭の中で運動の入口をつくり、親子で一緒に動ける導線を育てる。",
  },
  {
    key: "school",
    title: "小中学校",
...
export const sportsPublicIntro = {
  title: "このページについて",
  description:
    "このページは、深谷市のスポーツ推進に活かせる知識・企画・実行の土台を、分かりやすく整理するための試作ページです。",
  points: [
    "市民の方にとっては、日常の中で無理なく取り組める運動の入口として",
    "学校関係者の方にとっては、子どもたちの運動体験を支えるヒントとして",
    "行政・地域関係者の方にとっては、地域全体に運動習慣を広げる考え方の整理として",
  ],
  note: "今後、深谷市の文脈に合わせて、内容を少しずつ育てていく前提です。",
} as const;

export const sportsShareMessage = {
  title: "共有用メッセージ",
  description:
    "深谷市のスポーツ推進に活かせるよう、市民・学校・行政それぞれの視点から、実践の土台を整理し始めた試作ページです。",
  shortMessage:
  "深谷市のスポーツ推進に活かせるよう、市民・学校・行政それぞれの視点から、実践につながる形を整理し始めた試作ページです。ご確認いただけますと幸いです。",
} as const;
...
export const sportsAudienceNavigation = [
  {
    ...
    title: "市民の方へ",
    description:
      "日常生活の中で無理なく体を動かすきっかけや、家庭で取り入れやすい運動の入口を紹介します。",
...
export const sportsPrograms = [
  {
    title: "親子で動く、はじめの一歩",
    target: "小中学生 + 保護者",
    purpose: "運動の入口をつくり、家庭内での運動習慣につなげる",
    structure: [
      "5分：遊びながら体を動かす",
      "5分：バランス・姿勢",
      "5分：親子で協力する動き",
